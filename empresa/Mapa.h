...
public:
	...
	Resultado_Chequeos chequeo_demoler_edificio(const Coordenada& coordenada, string &edificio);
	...
	string demoler_edificio_ubicacion(const Coordenada& coordenada);
	...
	void poner_material_ubicacion(string material, const Coordenada& coordenada);
	...
	//ocupado
	string obtener_contenido_ubicacion(const Coordenada& coordenada) const;
...
private:
	...
	void generar_material(string material, Coordenada coordenada);
};
